    ...
    $mol_test({
        ...
        */
        'every kit component subclasses the one it replaces'($) {
            const context = $bog_kit_context.call($);
            const kit = context;
            const stock = Object.getPrototypeOf(context);
